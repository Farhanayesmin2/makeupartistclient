...
const Gallery = () => {
    return (
        <div>
<h1 className='text-rose-900 text-4xl font-serif font-bold'>Our Happy Bride</h1>

<h1>Here are, my recent makeover.All are not here,just little bit collection.</h1>
