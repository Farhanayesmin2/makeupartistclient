          ...
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-300">
            ...
            <details>
              ...
              <div className="px-4 pb-4 space-y-2">
                ...
                <p>
                  Any engine may run JavaScript. As a result, writing JavaScript
                  is incredibly easy, and any working environment is similar to
                  a complete browser. Node.js, on the other hand, only enables
                  the V8 engine. Written JavaScript code, on the other hand, can
                  run in any context, regardless of whether the V8 engine is
                  supported.
                </p>
              </div>
            </details>
