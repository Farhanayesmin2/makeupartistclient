      ...
      <footer className="py-6 bg-gray-100 text-gray-900 ">
        <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
          <div className="grid grid-cols-12">
            <div className="pb-6 col-span-full md:pb-0 md:col-span-6 text-center">
              <div className="flex">
                <div className="flex items-center justify-center text-md text-bold text-white w-16 h-16 rounded-full shadow-2xl shadow-pink-900 bg-rose-600">
                  Certified
                </div>
                <img
                  className="animate-pulse shadow-rose-600"
                  alt="/"
                  src={logo}
                ></img>
              </div>
