...
const MyReview = () => {
    ...
    return (
        <div>
            {
                publicReviews.map(review => (<> {user?.uid ? ( <div className="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md bg-gray-50 text-gray-800">
            ...
            <h1 className='text-4xl text-rose-800' >Your Review not yet.</h1>
